    ...
    {#if user}
        <div style="border: 1px solid #ccc; padding: 2rem; display: inline-block; border-radius: 8px;">
            ...
            <div style="margin-top: 1rem; display: flex; gap: 0.5rem; justify-content: center;">
                <a href="/{user.slug}" style="padding: 0.5rem 1rem; background-color: #2563eb; color: white; border-radius: 6px; text-decoration: none; font-weight: bold;">Ke Dashboard {user.slug}</a>
